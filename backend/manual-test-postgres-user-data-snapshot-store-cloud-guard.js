...
} = require('./manual-test-postgres-user-data-snapshot-store-cloud');

const validEnv = {
  RUN_004L_USER_DATA_SNAPSHOT_VERIFY: CONFIRMATION,
...
const config = assert004lCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004lCloudEnvironment({
    ...validEnv,
    RUN_004L_USER_DATA_SNAPSHOT_VERIFY: '',
  }),
