...
} = require('./manual-test-postgres-renewal-notification-store-cloud');

const validEnv = {
  RUN_004J_RENEWAL_NOTIFICATION_VERIFY: CONFIRMATION,
...
const config = assert004jCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004jCloudEnvironment({
    ...validEnv,
    RUN_004J_RENEWAL_NOTIFICATION_VERIFY: '',
  }),
