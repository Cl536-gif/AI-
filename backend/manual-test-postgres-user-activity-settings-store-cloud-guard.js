...
} = require('./manual-test-postgres-user-activity-settings-store-cloud');

const validEnv = {
  RUN_004D_ACTIVITY_SETTINGS_VERIFY: CONFIRMATION,
...
const config = assert004dCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004dCloudEnvironment({
    ...validEnv,
    RUN_004D_ACTIVITY_SETTINGS_VERIFY: '',
  }),
