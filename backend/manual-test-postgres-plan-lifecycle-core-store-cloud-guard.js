...
} = require('./manual-test-postgres-plan-lifecycle-core-store-cloud');

const validEnv = {
  RUN_004G_PLAN_LIFECYCLE_VERIFY: CONFIRMATION,
...
const config = assert004gCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004gCloudEnvironment({
    ...validEnv,
    RUN_004G_PLAN_LIFECYCLE_VERIFY: '',
  }),
