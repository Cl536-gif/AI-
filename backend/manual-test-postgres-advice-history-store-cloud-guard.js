...
} = require('./manual-test-postgres-advice-history-store-cloud');

const validEnv = {
  RUN_004K_ADVICE_HISTORY_VERIFY: CONFIRMATION,
...
const config = assert004kCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004kCloudEnvironment({
    ...validEnv,
    RUN_004K_ADVICE_HISTORY_VERIFY: '',
  }),
