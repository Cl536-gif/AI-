...
} = require('./manual-test-postgres-service-status-store-cloud');

const validEnv = {
  RUN_004E_SERVICE_STATUS_VERIFY: CONFIRMATION,
...
const config = assert004eCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004eCloudEnvironment({
    ...validEnv,
    RUN_004E_SERVICE_STATUS_VERIFY: '',
  }),
