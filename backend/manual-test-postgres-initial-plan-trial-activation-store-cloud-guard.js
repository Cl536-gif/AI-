...
} = require('./manual-test-postgres-initial-plan-trial-activation-store-cloud');

const validEnv = {
  RUN_004H_INITIAL_PLAN_TRIAL_VERIFY: CONFIRMATION,
...
const config = assert004hCloudEnvironment(validEnv);
...
assert.throws(
  () => assert004hCloudEnvironment({
    ...validEnv,
    RUN_004H_INITIAL_PLAN_TRIAL_VERIFY: '',
  }),
